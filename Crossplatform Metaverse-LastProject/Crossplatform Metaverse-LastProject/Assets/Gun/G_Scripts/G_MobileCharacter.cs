...
public class G_MobileCharacter : MonoBehaviour
{
    public Text textHP;
    ...
    public cshMobileFPMove moveScript;
    public GameObject fpGameObject;

    public cshMobileRaySpawn currentCamera;
    ...
    void Start()
    {
        moveScript = GetComponent<cshMobileFPMove>();
    }
